...
build-302594513: ../lab_ePwm_eCap_launchpad.syscfg
	...
	"E:/ti/CCS/ccs/utils/sysconfig_1.22.0/sysconfig_cli.bat" --script "D:/Programas/CCS/Workspace_epwm_lab/epwm_ecap_lp_f2837xd/lab_ePwm_eCap_launchpad.syscfg" -o "syscfg" -s "E:/ti/c2000/C2000Ware_5_04_00_00/.metadata/sdk.json" -b "/boards/LAUNCHXL_F28379D" --compiler ccs
...
syscfg/board.json: build-302594513
...
syscfg/%.obj: ./syscfg/%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	...
	"E:/ti/CCS/ccs/tools/compiler/ti-cgt-c2000_22.6.1.LTS/bin/cl2000" -v28 -ml -mt --cla_support=cla2 --float_support=fpu32 --tmu_support=tmu0 --vcu_support=vcu0 -Ooff --include_path="D:/Programas/CCS/Workspace_epwm_lab/epwm_ecap_lp_f2837xd" --include_path="D:/Programas/CCS/Workspace_epwm_lab/epwm_ecap_lp_f2837xd/device" --include_path="E:/ti/c2000/C2000Ware_5_04_00_00/driverlib/f2837xd/driverlib" --include_path="E:/ti/CCS/ccs/tools/compiler/ti-cgt-c2000_22.6.1.LTS/include" --define=DEBUG --define=CPU1 --define=_LAUNCHXL_F28379D --define=NO_SELECT_ECAP_INPUT --diag_suppress=10063 --diag_warning=225 --diag_wrap=off --display_error_number --abi=eabi --preproc_with_compile --preproc_dependency="syscfg/$(basename $(<F)).d_raw" --include_path="D:/Programas/CCS/Workspace_epwm_lab/epwm_ecap_lp_f2837xd/CPU1_RAM/syscfg" --obj_directory="syscfg" $(GEN_OPTS__FLAG) "$<"
	@echo 'Finished building: "$<"'
	@echo ' '
